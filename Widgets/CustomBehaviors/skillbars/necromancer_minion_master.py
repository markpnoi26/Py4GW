...
from Widgets.CustomBehaviors.skills.generic.minion_invocation_from_corpse_utility import MinionInvocationFromCorpseUtility
...
from Widgets.CustomBehaviors.skills.necromancer.blood_of_the_master import BloodOfTheMasterUtility
...
class NecromancerMinionMaster_UtilitySkillBar(CustomBehaviorBaseUtility):
    ...
    def __init__(self):
        ...
        # core skills
        self.animated_bone_fiend_utility: CustomSkillUtilityBase = MinionInvocationFromCorpseUtility(event_bus=self.event_bus, skill=CustomSkill("Animate_Bone_Fiend"), current_build=in_game_build, score_definition=ScoreStaticDefinition(60))
