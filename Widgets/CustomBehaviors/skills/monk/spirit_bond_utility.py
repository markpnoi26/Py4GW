...
class SpiritBondUtility(CustomSkillUtilityBase):
    ...
    def _get_target(self) -> int | None:
        ...
        target: int | None = custom_behavior_helpers.Targets.get_first_or_default_from_allies_ordered_by_priority(
            ...
            condition=lambda agent_id:
                ...
                (GLOBAL_CACHE.Agent.GetHealth(agent_id) is not None and GLOBAL_CACHE.Agent.GetHealth(agent_id) > 0.0),
    ...
    def _evaluate(self, current_state: BehaviorState, previously_attempted_skills: list[CustomSkill]) -> float | None:
        ...
        try:
            ...
            player_energy = GLOBAL_CACHE.Agent.GetEnergy(player_agent)
        except Exception:
