...
class AssassinVaettirFarm_Running_UtilitySkillBar(CustomBehaviorBaseUtility):
    ...
    def __init__(self):
        ...
        # others
        self.dark_escape_utility: CustomSkillUtilityBase = KeepSelfEffectUpUtility(skill=CustomSkill("Dark_Escape"), current_build=in_game_build, score_definition=ScoreStaticDefinition(50))
