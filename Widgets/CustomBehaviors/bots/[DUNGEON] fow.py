...
class secret_lair_of_the_snowmen(BottingAbstract):
    ...
    def bot_routine(self, bot_instance: Botting):
        ...
        self.enter_fow(bot_instance)
        self.a_tower_of_courage(bot_instance)
        self.b_the_wailing_lord(bot_instance)
        self.c_a_gift_of_griffons(bot_instance)
        self.d_the_eternal_forgemaster(bot_instance)
        self.e_defend_the_temple_of_war(bot_instance)
        self.f_restore_the_temple_of_war(bot_instance)
        # self.f_army_of_darkness(bot_instance)
        # self.h_khobay_the_betrayer(bot_instance)
        # self.i_tower_of_strength(bot_instance)
        # self.j_slaves_of_menzies(bot_instance)
        # self.k_the_hunt(bot_instance)

        bot_instance.States.AddHeader("END")

    def enter_fow(self, bot_instance: Botting):
    ...
    def a_tower_of_courage(self, bot_instance: Botting):
    ...
    def b_the_wailing_lord(self, bot_instance: Botting):
    ...
    def c_a_gift_of_griffons(self, bot_instance: Botting):
    ...
    def d_the_eternal_forgemaster(self, bot_instance: Botting):
    ...
    def e_defend_the_temple_of_war(self, bot_instance: Botting):
    ...
    def f_restore_the_temple_of_war(self, bot_instance: Botting):
    ...
    def h_khobay_the_betrayer(self, bot_instance: Botting):
    ...
    def x_army_of_darkness(self, bot_instance: Botting):
    ...
    def i_tower_of_strength(self, bot_instance: Botting):
        bot_instance.States.AddHeader("TOWER_OF_STRENGTH")

    def j_slaves_of_menzies(self, bot_instance: Botting):
        bot_instance.States.AddHeader("SLAVES_OF_MENZIES")

    def k_the_hunt(self, bot_instance: Botting):
    ...
    def description(self) -> str:
        return "The Fissure of Woe, also called the Realm of War. Your party has to complete 11 quests."