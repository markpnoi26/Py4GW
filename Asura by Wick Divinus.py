...
def Routine(bot: Botting) -> None:
    ...
    bot.Wait.UntilOutOfCombat()
    bot.Move.XYAndDialog(-10109, -17520, 0x84, "Taking Blessing")
    bot.Wait.UntilOutOfCombat()
    ...
    bot.Wait.UntilOutOfCombat()
    bot.Move.XYAndDialog(-2037, 10758, 0x84, "Taking Blessing")
    bot.Wait.UntilOutOfCombat()
    ...
    bot.Wait.UntilOutOfCombat()
    bot.Move.XYAndDialog(4893, 445, 0x84, "Taking Blessing")
    bot.Wait.UntilOutOfCombat()
