...
class ScreenOverlay:
    ...
    def create_overlay(self, ms: int = 500, destroy: bool = False) -> None: ...
    ...
    def draw_text_box(self, x:int, y:int, w:int, h:int, text:str, argb:int, px_size:float=16.0, family:str="Segoe UI", hcenter:bool=False, vcenter:bool=False) -> None: ...
...
class Overlay:
    ...
    def FindZ(self, x: float, y: float, pz: int=0) -> float: ...
    def FindZPlane(self, x: float, y: float, pz: int=0) -> int: ...
