...
def _generate_fallback_name(base_name: str) -> str:
    """
    Génère un nom GW valide sans chiffres.
    Utilise uniquement lettres + espace.
    """
    suffixes = [
        "Alt",
        "Tmp",
    ...
    # Choix pseudo-unique basé sur la longueur du nom
    index = len(base_name) % len(suffixes)
