from Py4GWCoreLib import Botting, get_texture_for_model, ModelID, GLOBAL_CACHE, Routines, ConsoleLog
import Py4GW
...
def DetectChestAndOpen(bot: Botting, max_distance=1000, max_attempts=3):
    ...
    for attempt in range(max_attempts):
        ...
        player_num = GLOBAL_CACHE.Agent.GetPlayerNumber(chest_id)
        ...
        if chest_pos:
            ...
            chest_still_exists = GLOBAL_CACHE.Agent.GetXY(chest_id)
...
def UnstuckPlayer():
    ...
    for offset_x, offset_y in offsets:
        ...
        check_pos = GLOBAL_CACHE.Player.GetXY()
