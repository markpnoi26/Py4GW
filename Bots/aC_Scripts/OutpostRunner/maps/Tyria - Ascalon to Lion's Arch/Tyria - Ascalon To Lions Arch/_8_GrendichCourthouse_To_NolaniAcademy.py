...
# 3) Map data (must be defined after the variables it references)
_8_grendichcourthouse_to_nolaniacademy_map_data = {
    "ids": {
        "outpost_id": outpost_name_to_id["Grendich Courthouse"],
        "explorable_ids": [
            explorable_name_to_id["Diessa Lowlands"],
            outpost_name_to_id["Nolani Academy outpost"]
        ]
    },
    "outpost_path": _8_grendichcourthouse_to_nolaniacademy_outpost_path,
    "segments": _8_grendichcourthouse_to_nolaniacademy_segments
}